def train_go1(headless=True):
    ...
    import os
    env = World(sim_device='cuda:0',headless=headless, cfg=Cfg, locomtion_model_dir=os.path.join(os.path.dirname(__file__), "/common/home/ag2112/walk-these-ways/walk-these-ways/runs/gait-conditioned-agility/pretrain-v0/train/025417.456545"))
