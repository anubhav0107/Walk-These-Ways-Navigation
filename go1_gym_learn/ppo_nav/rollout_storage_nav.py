...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, obs_history_shape, actions_shape, device='cpu'):
    ...
    def reccurent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_obs_batch, obs_history_batch, actions_batch, values_batch, advantages_batch, returns_batch, \
