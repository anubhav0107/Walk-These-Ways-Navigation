...
class PPO:
    ...
    def act(self, obs, obs_history):
        ...
        nav_actions = torch.clamp(self.transition.actions, min=-0.5, max=0.5)
        return nav_actions
    ...
    def update(self):
        ...
        for obs_batch, critic_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
            ...
            loss = 100*surrogate_loss + PPO_Args.value_loss_coef * value_loss #- PPO_Args.entropy_coef * entropy_batch.mean()
